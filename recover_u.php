         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-8 offset-md-2">
                  <form id="request" class="main_form" method="POST" action="find_answer.php">
                     <div class="row">
                        <div class="col-md-12 ">
                           <input class="form_control" readonly value="<?php echo $row['Recovery_Question'];?>" type="text"> 
                        </div>
                        <div class="col-md-12 ">
                           <input class="form_control" placeholder="Your Recovery Answer" type="text" name="ra"> 
                        </div>
                        <div class="col-md-12">
                           <div class="group_btn">
                           ...
                           <div class="hedingh3  flot_right text_align_left">
                              ...
                              <ul class="top_infomation">
                                 ...
                                 <li><i class="fa fa-envelope" aria-hidden="true"></i>
                                    <a href="mailto:mactilda.matsotso" style="font-size: 12px;">mactilda.matsotso@strathmore.edu</a>
                                 </li>
                              </ul>
                           </div>
                        </div>
