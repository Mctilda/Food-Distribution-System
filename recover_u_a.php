            ...
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage text_align_center">
                     <span>Area Administrator Reset Password</span>
                     <h2>Forgot Password?</h2>
                  </div>
               </div>
               <div class="col-md-8 offset-md-2">
                  <form id="request" class="main_form" method="POST" action="find_email1.php">
                     <div class="row">
                        <div class="col-md-12 ">
                           <input class="form_control" placeholder="Your Email Address" type="text" name="email"> 
                        </div>
                        <div class="col-md-12">
                           <div class="group_btn">
